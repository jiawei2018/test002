...
public class FindPairWithGivenSum {
     ...
     * You should return the pair with the largest number.//index num with largest num not the index sum is largest!
     *
     *
     *
     */
    public int[] FPWGS(int[] nums, int target){
...
// target - x = nums[i] => nums[i] + x = target
